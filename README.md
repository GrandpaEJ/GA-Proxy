...
This is a lightweight Go-based proxy server designed to be hosted on platforms like **Render**, **Vercel**, or **Railway**. It allows you to share your Groq or OpenRouter API keys with the PteroBill Panel to earn credits.
